...
if (app) {
  (0,_components_Login__WEBPACK_IMPORTED_MODULE_1__.loadLogin)(app, _components_Register__WEBPACK_IMPORTED_MODULE_2__.loadRegister);
}
...
function loadLogin(app, goRegister) {
  ...
  document.getElementById("loginForm").addEventListener("submit", /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(e) {
      var email, password, response, _t;
