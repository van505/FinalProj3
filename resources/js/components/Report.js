  ...
  `;
    ...
    async function fetchDropdowns() {
        try {
            ...
            courses.forEach((c) => {
                courseSelect.innerHTML += `<option value="${c.id}">${
                    c.name || c.course_name
                }</option>`;
            });
            departments.forEach((d) => {
                deptSelect.innerHTML += `<option value="${d.id}">${
                    d.name || d.department_name
                }</option>`;
            });
            years.forEach((y) => {
                yearSelect.innerHTML += `<option value="${y.id}">${
        ...
        try {
            ...
            tbody.innerHTML = data
                .map(
                    (item) => `
          <tr>
            <td>${item.first_name || item.firstname} ${
            ...
            <td><span class="status-badge ${
                item.yearstatus === "active" ? "active" : "inactive"
            }">
